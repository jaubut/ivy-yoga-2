export const state = () => ({
  classes: [
    ...
    },
    {
      id: 6,
      title: 'MOBILITÉ',
      description: 'Cette classe aborde des exercices spécifiques d’alignement postural, des mouvements fonctionnels, transition entre deux postures. Plusieurs possibilités sont offertes adaptées aux participants. Cours tous niveaux!',
